...
public class EnumMain {
	public static void main(String[] args) {
		...
		//열거형과 switch문
		//열거형 상수를 switch의 case에 쓸수 있다.
		
		switch(i1) {
		case START://Item.START처럼 사용하는것이 아닌 앞에 타입은 생략해서 사용할 수 있다.
		...
		for(Item item : items) {
			System.out.print(item.getItemStr() + " ");
